...
# Compares the accuracy of the approx algos with the normal ones, with an incrementing k value
# also saves the runtime. The data is then saved in a spreadsheet
def comp_reg_app():
    wrkbk = Workbook()
    ...
    btime = []
    btimea = []
    # compare distance and time with variable relaxations; fixed 00 nodes with max val 100
